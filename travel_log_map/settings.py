...
UNSPLASH_DEFAULT_SIZE = os.environ.get('UNSPLASH_DEFAULT_SIZE', '480x240')
UNSPLASH_FALLBACK_QUALITY = _env_int('UNSPLASH_FALLBACK_QUALITY', 80)
UNSPLASH_USE_SOURCE = os.environ.get('UNSPLASH_USE_SOURCE', 'false').lower() == 'true'
UNSPLASH_UTM_SOURCE = os.environ.get('UNSPLASH_UTM_SOURCE', 'TripLog')
UNSPLASH_UTM_MEDIUM = os.environ.get('UNSPLASH_UTM_MEDIUM', 'referral')
