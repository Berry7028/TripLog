...
urlpatterns = [
    ...
    path(
        "manage/spots/<int:pk>/edit/",
        admin_views.SpotAdminUpdateView.as_view(),
        name="admin_spot_edit",
    ),
    path(
        "manage/spots/<int:pk>/delete/",
        admin_views.SpotAdminDeleteView.as_view(),
        name="admin_spot_delete",
    ),
    ...
    path(
        "manage/tags/<int:pk>/edit/",
        admin_views.TagAdminUpdateView.as_view(),
        name="admin_tag_edit",
    ),
    path(
        "manage/tags/<int:pk>/delete/",
        admin_views.TagAdminDeleteView.as_view(),
        name="admin_tag_delete",
    ),
    path("manage/reviews/", admin_views.ReviewAdminListView.as_view(), name="admin_review_list"),
    path(
        "manage/reviews/add/", admin_views.ReviewAdminCreateView.as_view(), name="admin_review_add"
    ),
    path(
        "manage/reviews/<int:pk>/edit/",
        admin_views.ReviewAdminUpdateView.as_view(),
        name="admin_review_edit",
    ),
    path(
        "manage/reviews/<int:pk>/delete/",
        admin_views.ReviewAdminDeleteView.as_view(),
    ...
    path(
        "manage/users/<int:pk>/",
        admin_views.UserAdminDetailView.as_view(),
        name="admin_user_detail",
    ),
    path(
        "manage/users/<int:pk>/password/",
        admin_views.UserAdminPasswordChangeView.as_view(),
    ...
    path(
        "manage/groups/<int:pk>/edit/",
        admin_views.GroupAdminUpdateView.as_view(),
        name="admin_group_edit",
    ),
    path(
        "manage/groups/<int:pk>/delete/",
        admin_views.GroupAdminDeleteView.as_view(),
        name="admin_group_delete",
    ),
    path(
        "manage/profiles/",
        admin_views.UserProfileAdminListView.as_view(),
        name="admin_profile_list",
    ),
    path(
        "manage/spot-views/",
        admin_views.SpotViewAdminListView.as_view(),
        name="admin_spotview_list",
    ),
    # AIおすすめ管理
    path(
        "manage/recommendations/",
        admin_views.RecommendationAdminView.as_view(),
        name="admin_recommendation",
    ),
    path(
        "manage/recommendations/scores/",
        admin_views.RecommendationUserScoreListView.as_view(),
        name="admin_recommendation_scores",
    ),
    path(
        "manage/recommendations/logs/",
        admin_views.RecommendationJobLogListView.as_view(),
        name="admin_recommendation_logs",
    ),
]
