...
from .models import Review, Spot, Tag, UserProfile
...
class SpotForm(forms.ModelForm):
    ...
    tags_text = forms.CharField(
        ...
        widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "例: 海, 山, 絶景"}),
    )
    ...
    class Meta:
        ...
        widgets = {
            "title": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "スポット名を入力してください"}
            ),
            ...
            "latitude": forms.NumberInput(
                attrs={"class": "form-control", "step": "any", "placeholder": "緯度（例: 35.6762）"}
            ),
            ...
            "address": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "住所を入力してください"}
            ),
            "image": forms.FileInput(attrs={"class": "form-control", "accept": "image/*"}),
            "image_url": forms.URLInput(
                attrs={"class": "form-control", "placeholder": "https://example.com/image.jpg"}
            ),
        }
...
class ReviewForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "rating": forms.Select(
                choices=[(i, f"{i}★") for i in range(1, 6)], attrs={"class": "form-control"}
            ),
...
class ReviewAdminForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "rating": forms.Select(
                choices=[(i, f"{i}★") for i in range(1, 6)], attrs={"class": "form-select"}
            ),
